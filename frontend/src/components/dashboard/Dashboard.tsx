    ...
    <div className="max-w-[1400px] mx-auto p-4 md:p-10 space-y-8 md:space-y-12 animate-in fade-in duration-700">
      ...
      {dbStatus === 'disconnected' && (
        <motion.div 
          ...
          className="bg-red-50 border-2 border-red-100 p-6 rounded-[2rem] flex flex-col md:flex-row items-center gap-6 shadow-sm"
        >
          <div className="w-12 h-12 bg-red-100 rounded-2xl flex items-center justify-center shrink-0">
            <ShieldCheck className="text-red-600" />
          </div>
          <div className="flex-1 space-y-1 text-center md:text-left">
            <h3 className="text-sm font-black text-red-800 uppercase tracking-tight">Database Offline</h3>
            <p className="text-xs text-red-600/80 font-medium">
              The application is unable to connect to the MongoDB persistence layer. 
              Please provide a valid remote <b>MONGODB_URI</b> in the Settings menu. 
              Localhost addresses (127.0.0.1) are not supported.
            </p>
          </div>
          <a 
            ...
            className="px-6 py-3 bg-red-600 text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-red-700 transition-all font-sans"
          >
            Get Atlas URI
          </a>
        </motion.div>
